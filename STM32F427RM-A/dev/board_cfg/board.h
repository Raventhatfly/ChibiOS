...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(CAN2_RX) |         \
                                     PIN_OSPEED_HIGH(CAN2_TX) |         \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(CAN2_RX) |        \
                                     PIN_PUPDR_PULLUP(CAN2_TX) |        \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(CAN2_RX) |            \
                                     PIN_ODR_HIGH(CAN2_TX) |            \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_PIN8, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(CAN2_RX, 9U) |         \
                                     PIN_AFIO_AF(CAN2_TX, 9U) |         \
 ...
 * PG1  - PIN1                      (output pushpull).
 * PG2  - PIN2                      (output pushpull)
 * PG3  - PIN3                      (output pushpull)
 * PG4  - PIN4                      (output pushpull)
 * PG5  - PIN5                      (output pushpull)
 * PG6  - PIN6                      (output pushpull)
 * PG7  - PIN7                      (output pushpull)
 * PG8  - PIN8                      (output pushpull)
